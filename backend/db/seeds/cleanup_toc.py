...
files = ["toc-seed-p4.sql", "toc-seed-p5.sql", "toc-seed-p6.sql"]
words_to_strip = [
    ...
    "independently", "tracking", "checking", "mapping", "structurally", "evaluating", "defining", "validating", "analyzing", "measuring", "identifying", "computations", "resolving", "configurations", "parameters", "executing", "generating", "combinations"
]
